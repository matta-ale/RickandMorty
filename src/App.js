...
function App() {
 ...
 // eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  return (
    <div className='App'>
      {location.pathname !== ROUTES.LOGIN && <Nav onSearch={onSearch} randomNum={randomNum} handleLogout={handleLogout}/>}
      <Routes>
        {/* //las rutas hay que parametrizarlas. Carpeta helpers, archivo RoutesPath, objeto ROUTES.HOME */}
        <Route path={ROUTES.LOGIN} element={<Form handleLogin={handleLogin}/>}></Route>
